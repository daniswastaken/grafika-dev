...
/* Color correction */
#define NL_TONEMAP_TYPE                                                        \
  3                   // 1:Exponential, 2:Reinhard, 3:Extended Reinhard, 4:ACES
#define NL_GAMMA 1.3 // 0.3 low ~ 2.0 high
// #define NL_EXPOSURE 1.3              // [toggle] 0.5 dark ~ 3.0 bright
// #define NL_SATURATION 1.4            // [toggle] 0.0 grayscale ~ 4.0 super
// saturated #define NL_TINT                      // [toggle] enable light/dark
// tone tinting
...
#define NL_RAIN_MIST_OPACITY                                                   \
  0.12 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow
...
#define NL_RAINBOW_CLEAR 0.15 // 0.3 subtle ~ 1.0 bright during clear weather
...
// #define NL_GLOW_LEAK 0.6        // [toggle] 0.08 subtle ~ 1.0 100% brightness
// of NL_GLOW_TEX
...
// #define NL_EXTRA_PLANTS_WAVE // [toggle] !dont use! wave using texture coords
// (1.21.0 vanilla 2048x1024)
#define NL_WAVE_RANGE                                                          \
  13.0 // 6.0 upto 6 blocks ~ 32.0 upto 32 blocks away (slower)

/* Water */
#define NL_WATER_TRANSPARENCY 0.8 // 0.0 transparent ~ 1.0 normal
#define NL_WATER_BUMP 0.125       // 0.001 plain ~ 0.2 bumpy water
...
#define NL_UNDERWATER_STREAKS                                                  \
  1.0 // [toggle] 0.8 subtle - 2.0 bright streaks from top
...
#define NL_CLOUD2_SHAPE                                                        \
  vec2(0.5, 0.4) // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
...
/* Galaxy */
#define NL_GALAXY_STARS 0.8          // [toggle] 0.1 dim - 4.0 bright
#define NL_GALAXY_VIBRANCE 0.9       // 0.0 white - 1.0 colorful
...
// #define NL_CHUNK_LOAD_ANIM 100.0 // [toggle] -600.0 fall from top ~ 600.0
// rise from bottom
...
/* Sky reflection */
// #define NL_GROUND_REFL 0.4       // [toggle] 0.2 slightly reflective ~ 1.0
// fully reflect sky
#define NL_GROUND_RAIN_WETNESS                                                 \
  1.0 // 0.0 no wetness ~ 1.0 fully wet blocks when raining
...
#define NL_ENTITY_EDGE_HIGHLIGHT                                               \
  0.41 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
...
#define NL_LAVA_NOISE_SPEED 0.4 // 0.0 still ~ 0.8 fast
